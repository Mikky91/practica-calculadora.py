...
def add_to_calculation(symbol):
    #variable global para que se pueda manipular dentro de la funcion 
    global calculation
...
btn_clear = tk.Button(root, text="Supr", command= clear_field, width=11, font=("Arial", 14))
